    ...
    <div className="p-4 md:p-8 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="ic-h1 text-3xl md:text-4xl text-slate-900">
              Bem-vindo de volta! 👋
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="shadow-md bg-gradient-to-br from-blue-50 to-indigo-50">
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase tracking-wide">Novos este mês</p>
                  <p className="ic-metric text-2xl text-slate-900">{novosEsteMes}</p>
                </div>
              </CardContent>
            </Card>

            <Card className="shadow-md bg-gradient-to-br from-slate-50 to-slate-100">
              <CardContent className="p-5 flex items-center gap-4">
                <div className="p-3 bg-slate-200 rounded-xl">
                  <TrendingUp className="w-5 h-5 text-slate-600" />
                </div>
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase tracking-wide">Mês anterior</p>
                  <p className="ic-metric text-2xl text-slate-900">{novosMesAnterior}</p>
                </div>
              </CardContent>
            </Card>

            <Card className="shadow-md bg-gradient-to-br from-emerald-50 to-green-50">
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase tracking-wide">Variação</p>
                  <p className={`ic-metric text-2xl ${crescimentoDiff >= 0 ? 'text-emerald-700' : 'text-red-600'}`}>
                  ...
                  <CardHeader className="pb-3 border-b-0">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="ic-metric text-3xl text-slate-900 mt-2">{stat.value}</p>
                      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              {canInstall && (
                <Button
                  ...
                  type="button"
                >
                  <img src={appLogo} alt="Logo Igreja Conectada" className="w-4 h-4" />
                  Instalar como app
                </Button>
              )}
            </div>
            ...
            {loadingMembros ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {Object.entries(membrosPorTipo).map(([tipo, count]) => (
                  <div key={tipo} className="text-center p-4 bg-slate-50 rounded-xl">
                    <p className="ic-metric text-3xl text-slate-900">{count}</p>
